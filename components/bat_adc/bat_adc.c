...
//ADC Channels
#define ADC_EXAMPLE_CHAN0    ADC1_CHANNEL_3  //ADC2_CHANNEL_7   // GPIO18
...
esp_err_t adc_init(void)
{
    ...
    //ADC2 config
    ESP_ERROR_CHECK(adc1_config_channel_atten(ADC_EXAMPLE_CHAN0, ADC_EXAMPLE_ATTEN));
...
uint16_t adc_get_voltage(void)
{
    ...
    adc_raw = adc1_get_raw(ADC_EXAMPLE_CHAN0);
