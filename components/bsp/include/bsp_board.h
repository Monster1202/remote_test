...
#define GPIO_LCD_CS     (GPIO_NUM_48)
#define GPIO_LCD_RST    (GPIO_NUM_13)
#define GPIO_LCD_RS     (GPIO_NUM_47)
#define GPIO_LCD_WR     (GPIO_NUM_21)
#define GPIO_LCD_RD     (GPIO_NUM_14)

#define GPIO_LCD_D00    (GPIO_NUM_12)
#define GPIO_LCD_D01    (GPIO_NUM_11)
#define GPIO_LCD_D02    (GPIO_NUM_10)
#define GPIO_LCD_D03    (GPIO_NUM_9)
#define GPIO_LCD_D04    (GPIO_NUM_46)
#define GPIO_LCD_D05    (GPIO_NUM_3)
#define GPIO_LCD_D06    (GPIO_NUM_20)
#define GPIO_LCD_D07    (GPIO_NUM_19)
#define GPIO_LCD_D08    (GPIO_NUM_8)
#define GPIO_LCD_D09    (GPIO_NUM_18)
#define GPIO_LCD_D10    (GPIO_NUM_17)
#define GPIO_LCD_D11    (GPIO_NUM_16)
#define GPIO_LCD_D12    (GPIO_NUM_15)
#define GPIO_LCD_D13    (GPIO_NUM_7)
#define GPIO_LCD_D14    (GPIO_NUM_6)
#define GPIO_LCD_D15    (GPIO_NUM_5)

#define GPIO_LED_RUN    (GPIO_NUM_1)
#define GPIO_LED_ERR    (GPIO_NUM_2)
#define GPIO_OUTPUT_PIN_SEL  ( (1ULL<<GPIO_LED_RUN)| (1ULL<<GPIO_LED_ERR))

#define GPIO_BAT_ADC    (GPIO_NUM_4)

#define GPIO_INT_0    (GPIO_NUM_39)

#define GPIO_TP_RST    (GPIO_NUM_38)
#define GPIO_TP_INT    (GPIO_NUM_37)
#define GPIO_TP_SDA    (GPIO_NUM_36)
#define GPIO_TP_SCL    (GPIO_NUM_35)
